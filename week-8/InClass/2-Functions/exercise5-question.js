...
let greetName = "Hello " + firstName1 + " " + surname1;
let greeting1 = greeting(greetName);

let firstName2 = "Eric";
let surname2 = "Yuan";
// Change the line below to call your function!
let greeting2 = greeting("Hello " + firstName2 + " " + surname2);

let firstName3 = "Jeff";
let surname3 = "Bezos";
// Change the line below to call your function!
let greeting3 = greeting("Hello " + firstName3 + " " + surname3);
